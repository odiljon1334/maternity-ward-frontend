...
// Shu sahifadan faqat o'z shifoxonasi darajasidagi rollar tayinlanadi —
// ASSISTANT_ADMIN (platforma darajasi, boshqa shifoxonalarga ham
// biriktirilishi mumkin) atayin bu yerga kiritilmagan, u faqat
// SUPER_ADMIN'ning /panel/hospitals sahifasidan boshqariladi.
const ASSIGNABLE_ROLES = ["ADMIN", "DIRECTOR", "DEPARTMENT_HEAD", "EMPLOYEE"];
// Platforma darajasidagi rollar (SUPER_ADMIN/MINISTRY/ASSISTANT_ADMIN) —
// texnik jihatdan bu shifoxonaning ro'yxatida ko'rinmasligi kerak
// (hospitalId ustuni bo'sh), lekin baribir ehtiyot chorasi sifatida
// tahrirlanmaydigan qilib belgilanadi.
const PLATFORM_ROLES = ["SUPER_ADMIN", "MINISTRY", "ASSISTANT_ADMIN"];
...
export default function AdminUsersPage() {
  ...
  // targetHospitalId yuborilmaydi — ADMIN/DIRECTOR uchun backend hospitalId'ni
  // har doim JWT'dan oladi, shuning uchun bu yerda faqat o'z shifoxonasi
  // foydalanuvchilari qaytadi (users.controller.ts, resolveHospitalId).
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Shifoxonangiz xodimlarining login-hisoblarini (rol, status) shu yerdan boshqaring.
        </p>
      </div>
