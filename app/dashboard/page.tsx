...
import TopLateCard from "@/components/dashboard/TopLateCard";
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0b0d17] text-slate-900 dark:text-slate-100 font-sans">
      ...
      <div className="p-4 sm:p-6 space-y-6 max-w-[1600px] mx-auto">
        ...
        {/* ── 6. Ko'p kechikkanlar (ilgari bu yerda bugungi keldi-ketdi jadvali edi —
               u yuqoridagi real-time tasmaga ko'chirildi) ── */}
        <TopLateCard topLate={topLate} />
