...
export function LiveMapShowcase({ onOpenTrial }: { onOpenTrial?: () => void }) {
  ...
  return (
    <section id="live-map" className="py-20 lg:py-28 bg-white text-slate-900 relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-slate-900">
            Mobil Check-in qilsa <span className="text-emerald-600">Live Xarita</span> ishga tushadi. <br className="hidden sm:inline" />
            Check-out qilsa — <span className="text-slate-500">kuzatuv butunlay uziladi</span>.
          </h2>
        ...
        <div className="rounded-3xl bg-white border border-slate-200 shadow-2xl p-6 sm:p-8 lg:p-10 space-y-8 backdrop-blur-xl">
          {/* Simulator Toggle Controls */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-3 rounded-2xl bg-slate-50 border border-slate-200">
            <div className="flex items-center gap-3 text-xs sm:text-sm">
              <span className="font-bold text-slate-600">Xodim holatini sinab ko&apos;ring:</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 relative h-[380px] sm:h-[440px] rounded-3xl bg-slate-100 border border-slate-200 overflow-hidden shadow-inner flex flex-col justify-between p-6">
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/90 border border-slate-200 text-xs font-bold shadow-sm">
                ...
                >
                  <span
                    className={cn(
                      ...
                      simulatedState === "checked_in" ? "bg-emerald-500 animate-ping" : "bg-slate-400"
                    )}
                  />
              ...
              <div className="relative z-10 flex items-center justify-center">
                {simulatedState === "checked_in" ? (
                  <div className="relative flex flex-col items-center animate-in fade-in zoom-in-95 duration-300">
                    ...
                    {/* Popup Card */}
                    <div className="mt-3 px-4 py-2 rounded-2xl bg-white border border-emerald-200 text-center shadow-xl space-y-0.5">
                      <p className="text-xs font-bold text-slate-900">Dr. Nilufar Karimova</p>
                      <p className="text-[11px] text-emerald-600 font-semibold">1-son Tug&apos;ruq bo&apos;limi • 45 metr masofada</p>
                      <div className="flex items-center justify-center gap-2 text-[10px] text-slate-500 pt-1">
                        <span className="flex items-center gap-1">
                          <Battery className="w-3 h-3 text-emerald-600" /> 88%
                        </span>
                        <span>•</span>
                        <span className="flex items-center gap-1">
                  ...
                  <div className="flex flex-col items-center text-center p-6 rounded-3xl bg-white border border-slate-200 max-w-sm animate-in fade-in zoom-in-95 duration-300 space-y-3 shadow-lg">
                    <div className="w-14 h-14 rounded-2xl bg-slate-100 text-slate-500 flex items-center justify-center">
                      <EyeOff className="w-7 h-7" />
                    </div>
                    <h4 className="text-base font-bold text-slate-900">Kuzatuv To&apos;xtatildi</h4>
              ...
              {/* Map Footer status */}
              <div className="relative z-10 flex items-center justify-between text-[11px] text-slate-500 pt-2 border-t border-slate-200">
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3.5">
                  ...
                  <div className="space-y-0.5 text-xs">
                    <h4 className="font-bold text-slate-900 text-sm">Ishdan tashqarida kuzatuv yo&apos;q</h4>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3.5">
                  ...
                  <div className="space-y-0.5 text-xs">
                    <h4 className="font-bold text-slate-900 text-sm">Kasalxona ichida aniq geofencing</h4>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3.5">
                  ...
                  <div className="space-y-0.5 text-xs">
                    <h4 className="font-bold text-slate-900 text-sm">Batareyani tejovchi algoritm</h4>
                    <p className="text-slate-600 leading-relaxed">
