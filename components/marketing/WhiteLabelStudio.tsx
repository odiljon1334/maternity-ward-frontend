...
export function WhiteLabelStudio() {
  ...
  return (
    <section id="whitelabel" className="py-20 sm:py-28 relative overflow-hidden bg-white text-slate-900">
      {/* Background glow */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-blue-50 to-purple-50 text-blue-700 border border-blue-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Controls column */}
          <div className="lg:col-span-4 bg-slate-50 rounded-3xl border border-slate-200 p-6 sm:p-7 space-y-6 flex flex-col justify-between backdrop-blur-xs">
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-300 bg-white text-slate-900 font-semibold text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-slate-300 bg-white text-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="p-4 rounded-2xl bg-white border border-slate-200 space-y-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-slate-500">Faollashgan modul:</span>
                  <span className="font-bold text-emerald-600">{selectedPreset.moduleBadge}</span>
                </div>
          ...
          {/* Live Preview Column */}
          <div className="lg:col-span-8 bg-slate-50 rounded-3xl border border-slate-200 p-6 sm:p-7 flex flex-col justify-between shadow-2xl relative overflow-hidden">
            {/* View mode switcher */}
            ...
            <div className="py-6 flex-1 flex flex-col justify-center">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-xl">
                  ...
                  <div className="px-4 py-2.5 bg-slate-50 border-b border-slate-200 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-[11px] text-slate-500 pl-2">
                  ...
                  <div className="p-5 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <div className="hidden sm:flex items-center gap-2">
                      <span className="px-2.5 py-1 rounded-lg bg-emerald-50 text-emerald-700 text-xs font-semibold flex items-center gap-1.5">
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <div className="space-y-2">
                      {selectedPreset.sampleEmployees.map((emp, i) => (
                        <div
                          key={i}
                          className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between text-xs hover:bg-slate-100 transition-colors"
                        >
                          <div className="flex items-center gap-3">
              ...
              {previewMode === "mobile" && (
                <div className="max-w-xs mx-auto w-full rounded-3xl border-4 border-slate-200 bg-white p-4 shadow-2xl space-y-4">
                  <div className="w-20 h-3.5 bg-slate-200 rounded-full mx-auto" />
                  <div className="text-center pt-2 space-y-1">
                    ...
                    <p className="text-[10px] text-slate-500">Xodim Shaxsiy Kabineti</p>
                  </div>

                  <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 space-y-1 text-xs">
                    <div className="flex justify-between text-slate-500 text-[11px]">
                      <span>Bugungi Smena:</span>
                      <span className="text-slate-900 font-bold">{selectedPreset.shiftTypes[0]}</span>
                    </div>
                    <div className="flex justify-between text-slate-500 text-[11px]">
                      <span>Kirish vaqti:</span>
                      <span className="text-emerald-600 font-mono font-bold">08:00 (O&apos;z vaqtida)</span>
                    </div>
                  </div>
              ...
              {previewMode === "telegram" && (
                <div className="max-w-md mx-auto w-full rounded-2xl border border-slate-200 bg-white p-4 shadow-xl space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-slate-100 text-xs">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-slate-500">Rasmiy Rahbariyat Xabarnomasi</span>
                    </div>
                  </div>

                  <div className="p-3.5 rounded-xl bg-slate-50 text-xs space-y-2 border border-slate-200 font-sans">
                    ...
                    <div className="p-2 rounded bg-amber-50 font-mono text-[10px] text-amber-700">
