...
const mainNavItems: NavItem[] = [
  ...
  { href: "/dashboard/labor-law",         label: "Mehnat huquqi",      icon: BookOpen,       exact: false, roles: ["EMPLOYEE"] },
  ...
  { href: "/dashboard/labor-law",         label: "Mehnat huquqi",      icon: BookOpen,       exact: false, roles: ["SUPER_ADMIN", "ASSISTANT_ADMIN", "ADMIN", "DIRECTOR", "DEPARTMENT_HEAD"] },
